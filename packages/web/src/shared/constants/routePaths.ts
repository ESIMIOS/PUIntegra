...
export const routePaths = {
  ...
  adminInstitutionRequests: (rfc: string) => `/admin/${rfc}/requests`,
  adminInstitutionRequestDetail: (rfc: string, fub: string) => `/admin/${rfc}/requests/${fub}`,
  adminInstitutionPlan: (rfc: string) => `/admin/${rfc}/plan`,
  adminInstitutionContacts: (rfc: string) => `/admin/${rfc}/contacts`,
  adminTenantPermissions: (rfc: string) => `/admin/${rfc}/permissions`,
  adminLogs: '/admin/logs',
  accountInstitutions: '/account/institutions',
...
export const allDocumentedPaths = [
  ...
  routePaths.adminTenantPermissions(DEFAULT_RFC),
  routePaths.adminLogs,
  routePaths.accountInstitutions,
