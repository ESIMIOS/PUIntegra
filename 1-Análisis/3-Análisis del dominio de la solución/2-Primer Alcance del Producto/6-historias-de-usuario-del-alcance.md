...
| `US-IAD-02` | Como `INSTITUTION_ADMIN`, quiero consultar un dashboard de la institución activa para informarme rápidamente del estado general de su operación. | `/app/[RFC]/dashboard` | El usuario puede visualizar un resumen operativo de la institución activa, incluyendo la distribución del estado de sincronización PUI de los hallazgos. | El dashboard depende del contexto institucional activo. |
...
| `US-IAD-06` | Como `INSTITUTION_ADMIN`, quiero consultar los contactos técnicos, legales y de búsqueda inmediata de mi institución. | `/app/[RFC]/admin/contacts` | El usuario puede ver la información de contactos institucionales registrada. | Los contactos siguen siendo datos informativos, no roles operativos. |
...
| `US-IOP-02` | Como `INSTITUTION_OPERATOR`, quiero consultar un dashboard de la institución activa para informarme rápidamente del estado general de su operación. | `/app/[RFC]/dashboard` | El usuario puede visualizar un resumen operativo de la institución activa, incluyendo la distribución del estado de sincronización PUI de los hallazgos. | Comparte lectura operativa, no facultad administrativa. |
