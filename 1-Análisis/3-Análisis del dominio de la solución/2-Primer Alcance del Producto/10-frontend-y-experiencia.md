...
| `/app/[RFC]/admin/contacts` | Aplicación institucional | Mostrar los contactos institucionales. | `INSTITUTION_ADMIN`. | No | Debe distinguir contactos legales, técnicos y de búsqueda inmediata. |
